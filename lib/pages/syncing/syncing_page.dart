          ...
          trailing: Row(
            ...
            children: [
              Checkbox(
                ...
                //fillColor: WidgetStatePropertyAll(Theme.of(context).colorScheme.secondary),
              ),
              IconButton(icon: const Icon(Icons.more_vert), onPressed: () {},color: Theme.of(context).colorScheme.secondary,),
            ],
          ),
          onTap: () {
            // do something
