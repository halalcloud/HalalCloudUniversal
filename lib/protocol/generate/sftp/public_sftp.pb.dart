...
class SftpConfig extends $pb.GeneratedMessage {
  factory SftpConfig({
  ...
  SftpConfig._() : super();
  factory SftpConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SftpConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SftpConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'v6.services.pub'), createEmptyInstance: create)
  ...
  SftpConfig clone() => SftpConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SftpConfig copyWith(void Function(SftpConfig) updates) => super.copyWith((message) => updates(message as SftpConfig)) as SftpConfig;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SftpConfig create() => SftpConfig._();
  SftpConfig createEmptyInstance() => create();
  static $pb.PbList<SftpConfig> createRepeated() => $pb.PbList<SftpConfig>();
  @$core.pragma('dart2js:noInline')
  static SftpConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SftpConfig>(create);
  static SftpConfig? _defaultInstance;
  ...
  @$pb.TagNumber(15)
  $core.String get sshKey => $_getSZ(14);
  @$pb.TagNumber(15)
  set sshKey($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(15)
  $core.bool hasSshKey() => $_has(14);
  @$pb.TagNumber(15)
  void clearSshKey() => clearField(15);
}
